...
\section{\color{deep-blue} About Me}
  ...
  In the last 5 years, I've expended my skillsets to line management, team and technical leadership. \newline
%  \medskip \newline
  I am a pragmatic engineer who loves empowering other engineers to have impact and grow.


\section{\color{deep-blue} Experience}
  \cventry{Today \\ Apr. 2020 \\ 5+ years}{Technical Lead}{Lyst}{London}{}{
    \begin{itemize} \setlength\itemsep{5pt}
      \item Line management of up to 5 people, supporting career growth through regular coaching, feedback, and performance reviews; mentored senior ICs including engineering managers and tech leads.
      \item Tech Lead for the Shopping Experience frontend team (8 people across web, mobile, backend, design and QA).
      \item Led the delivery of a new in-house checkout enabling customers to purchase products from multiple retailers in a single transaction, supporting a key company-wide strategic initiative.
      \item Tech Lead for the Product Data backend team (6 people), responsible for the end-to-end data pipeline ingesting data from 2,000+ partners and maintaining a catalogue of 8M+ products.
      \item Drove the redesign of a 13-year-old integration platform, significantly reducing onboarding complexity and cost while improving data quality and scalability of partner integrations.
      \item Technologies: Python, JavaScript, React, Kubernetes, AWS Services (SQS, Kinesis, EKS, S3, RDS/Aurora, \ldots)
    \end{itemize}
  }
...
\section{\color{deep-blue} Interests}
  \cvitem{Sports}{Kung Fu (8 years, Brown Belt), Squash}
